...
quality:
	...
	@! grep -rn "TODO\|FIXME\|HACK\|console\.log\|println\|print(" backend/ frontend/src/ 2>/dev/null | grep -v "node_modules" || { echo "ERROR: debug output or TODO found. Fix: remove before ship"; exit 1; }
